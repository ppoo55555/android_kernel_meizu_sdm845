...
enum pon_restart_reason {
	...
	/* Meizu moment 1 */
	PON_RESTART_REASON_OEM		= 0x07,
	PON_RESTART_REASON_OTHER	= 0x08,
	PON_RESTART_REASON_NULL		= 0x09,
	PON_RESTART_REASON_EDL		= 0x0a,
	PON_RESTART_REASON_PANIC	= 0x0b,
	PON_RESTART_REASON_NORMAL_ANDROID	= 0x0c,
	PON_RESTART_REASON_NORMAL	= 0x0d,
	...
	/* Meizu moment 2 */
	PON_RESTART_REASON_ENTER_FFBM	= 0x41,
	PON_RESTART_REASON_EXIT_FFBM	= 0x42,
};
